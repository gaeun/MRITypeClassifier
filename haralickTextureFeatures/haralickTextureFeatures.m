...
%
%
% input:            glcm - Co-Occurence-Matrix.
%                   merkmale (optional) - Feature, which should be
%                   calculated
%
% output:           x - vector with the following features:
%
%               x1  Angular Second Moment (Energy)
%               x2  Contrast
%               x3  Correlation
%               x4  Variance
%               x5  Inverse Difference Moment (Homogeneity)
%               x6  Sum Average
%               x7  Sum Variance
%               x8  Sum Entropy
%               x9  Entropy
%               x10 Difference Variance
%               x11 Difference Entropy
%               x12 Information Measure of Correlation I 
%               x13 Information Measure of Correlation II
%               x14 Maximal Correlation Coefficient 
